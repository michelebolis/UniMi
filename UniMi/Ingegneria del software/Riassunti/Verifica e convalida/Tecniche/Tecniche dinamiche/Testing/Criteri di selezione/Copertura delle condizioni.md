Un test T soddisfa il criterio di copertura delle condizioni SE e SOLO SE `ogni singola condizione viene resa sia vera che falsa in corrispondenza di almeno un caso di test t contenuto in T`
