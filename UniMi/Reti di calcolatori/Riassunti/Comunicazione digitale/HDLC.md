...
Tra il livello 2 e il livello 1 il trasmettitore aggiunge una sequenza di bit all'inizio e alla fine, flag formata da 8 bit: 0 111 111 0
...
Il ricevitore sa che la sequenza finale di flag non è il payload grazie al `bit staffing` che aggiunge nelle sequenze del payload che corrispondono al flag, uno 0 dopo cinque 1 (il ricevitore aggiunge un delay di un bit)
